...
def Initiate(event):
    global title1,title2,title3,title4,title5,title6,title7,title,Var,Var1,String,String1,custom_font,Z,word,correctLetters,missedLetters,l,z
...
def Hangman_Game(event):
    ...
    global title1,title2,title3,title4,title5,title6,title7,title,Var,Var1,String,String1,custom_font,HANGMAN_PICS,Win,word,correctLetters,missedLetters,l,z
